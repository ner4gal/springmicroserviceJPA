...
import com.algotechnica.springmicroservicejpa.util.SpringUtils;





@WebServlet(urlPatterns = { "/nergal.svc/*" }

, initParams = {
		@WebInitParam(name = "javax.ws.rs.Application", value = "org.apache.olingo.odata2.core.rest.app.ODataApplication"),
		@WebInitParam(name = "org.apache.olingo.odata2.service.factory", value = "com.algotechnica.springmicroservicejpa.processor.MyODataProcessor") 
		}
...
public class BuilderODataServlet extends ODataServlet {
	...
	private String oDataServiceFactoryBeanName = "com.algotechnica.springmicroservicejpa.processor.MyODataServiceFactory";
